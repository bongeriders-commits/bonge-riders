...
export default async function handler(req, res) {
  ...
  // ── AUTH CHECK ──
  // Previously this endpoint was wide open: anyone who found the URL could
  // POST any title/body/url and push it to every installed device — a
  // ready-made phishing vector (e.g. a fake "payment confirmed, tap here"
  // notification). Now it requires a valid admin ID token, same pattern as
  // the rest of the admin-only actions in the app.
